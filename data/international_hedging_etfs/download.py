...
DATA = ROOT / "data"
TICKERS = ['VGK', 'EWJ', 'EWU', 'EWG', 'EWQ', 'EWL', 'EWA', 'EWC', 'EWN', 'EWD', 'EWI', 'EWP', 'EWH', 'EWS', 'INDA', 'FXI', 'EWZ', 'EWW', 'EWT', 'HEFA', 'DXJ', 'HEZU', 'FXE', 'FXY', 'FXC', 'FXA', 'MCHI', 'KWEB', 'ASHR', 'EWY', 'EZU']
OUTPUT = DATA / "international_hedging_etfs.csv"
