...
DATA = ROOT / "data"
TICKERS = ['XIC.TO', 'XIU.TO', 'XFN.TO', 'XEG.TO', 'XMA.TO', 'XRE.TO', 'XUT.TO', 'XST.TO', 'XIT.TO', 'XGD.TO', 'ZEB.TO', 'XSB.TO', 'XBB.TO', 'XGB.TO', 'XLB.TO', 'CGL-C.TO']
OUTPUT = DATA / "canada_sector_etfs.csv"
