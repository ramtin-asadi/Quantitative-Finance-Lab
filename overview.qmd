...
Project 24 has three layers: step-by-step calculations and evidence handling, explicit composition of atomic library functions, and a final analysis facade. Its final cells answer new financial questions with the same tuned local model, retrieved evidence and calculated context. It has no second-country repeat or alternative-model comparison.

## Current project areas

The 24 projects span the following areas. Individual notebooks are listed on the [home page](index.qmd#projects) and in the repository README.
